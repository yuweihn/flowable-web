...
// 根据deployId查询详情
export function getProcDefInfoByDeployId(deployId) {
  return request({
    url: '/flowable/definition/info/by-deploy-id',
    method: 'get',
...
// 删除流程定义
export function delProcDef(deployIds) {
  return request({
    url: '/flowable/definition/' + deployIds,
    method: 'delete'
  })
}
...
export function queryProcDefIdByDeployId(query) {
  return request({
    url: '/flowable/definition/deploy-to-def-id',
    method: 'get',
    params: query
  })
}
