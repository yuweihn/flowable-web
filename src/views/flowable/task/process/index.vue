...
<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="流程ID" prop="procInsId">
        <el-input v-model="queryParams.procInsId" placeholder="请输入流程ID" clearable size="small" @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete" v-hasPermi="['flowable:instance:remove']">删除</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="myProcessList" border @selection-change="handleSelectionChange">
      ...
      <el-table-column label="流程实例ID" align="center" prop="procInsId" :show-overflow-tooltip="true" width="140"/>
      <el-table-column label="流程实例编号" align="left" prop="procInsNo" width="200px"/>
      <el-table-column label="流程定义名称" align="center" prop="procDefName" :show-overflow-tooltip="true" width="120"/>
      ...
      <el-table-column label="标题" align="left" prop="title" :show-overflow-tooltip="true" width="255"/>
      <el-table-column label="提交时间" align="center" prop="createTime" :show-overflow-tooltip="true" width="170">
        <template slot-scope="scope">
      ...
      <el-table-column label="耗时" align="center" prop="duration" :show-overflow-tooltip="true" width="180"/>
      <el-table-column label="当前节点" align="center" prop="taskName" :show-overflow-tooltip="true" width="150"/>
      <el-table-column label="办理" align="center"  width="150">
        <template slot-scope="scope">
    ...
    <!-- 发起流程 -->
    <el-dialog :title="title" :visible.sync="open" width="650px" append-to-body v-drag  @close="closeDialog">
      <el-form ref="queryParams" :model="queryParams">
        <el-form-item label="流程类别">
          <el-select v-model="queryParams.category" clearable size="small" placeholder="请选择流程类别" @change="listDefinition" @clear="listDefinition('clear')">
            <el-option v-for="dict in procCategoryList" :key="dict.dictValue" :label="dict.dictLabel" :value="dict.dictValue"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
  ...
  methods: {
    ...
    getList() {
      ...
      var params = {
        ...
        procInsId: this.queryParams.procInsId ? this.queryParams.procInsId : null,
