<template>
    ...
    <el-form :model="formValue" label-width="110px" :rules="addFormRules" ref="formValue">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="客户经理" prop="salesUserId" v-if="operation!= 'add'" >
            <el-select :disabled="true" v-model="formValue.salesUserId" placeholder="" @change="onSalesChanged($event)"
