<template>
  <div class="app-container">
    ...
    <el-form-item label="客户编号" prop="customerNo" v-if="role">
      ...
      <el-form-item label="客户状态" prop="statusCode">
        ...
        <el-select v-model="queryParams.salesUserId" placeholder="客户经理" @change="onSalesChanged($event)"
                :remote-method="initSalesList" clearable filterable remote size="small" style="width: 200px;">
    ...
    <el-pagination layout="total, sizes, prev, pager, next, jumper" background
     ...
     v-on:success="getCustomerList" :isShow = "isShow" :FormData = "FormData" />
  </div>
</template>

<script>
import {listCustomer, delCustomer} from "@/api/system/customer";
...
export default {
  ...
  methods: {
    ...
    getCustomerList() {
      this.loading = true;
      listCustomer(this.queryParams).then(resp => {
